                    ...
                    <div class="card-body">
                      <form method="POST" onsubmit="return verification();">
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="nom_categorie" name="nom_categorie" placeholder="Nom categorie">
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <textarea id="description_categorie" class="form-control" placeholder="description de votre categorie" aria-label="description de votre categorie" aria-describedby="basic-icon-default-message2" 
                            name="description_categorie"></textarea>
                          </div>
                        </div>
