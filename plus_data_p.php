        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"> Settings /</span> Gestion categorie</h4>
 ...
 ?>
                  ...
                  <div class="card h-100">
                    <div class="card-body">
                      ...
                      <h6 class="card-subtitle text-muted"><?php echo $row['prix_produit'] ?></h6>
                    </div>
                   <div style="right: 0px;
    position: absolute;"> <a href="modifier_data_p.php?id=<?php echo $row['id_produit'] ?>"  class="btn btn-primary">Modifier</a>
                         
                        <a href="delete_data_p.php?id=<?php echo $row['id_produit'] ?>"  class="btn btn-danger">Supprimer</a>
                    
                       </div>
                    <img class="img-fluid" src="uploads/<?php echo $row['image'] ?>" alt="Card image cap" style="    width: 58%;
    height: 300px;">
                    <div class="card-body"><?php echo $row['description_produit'] ?></p>
